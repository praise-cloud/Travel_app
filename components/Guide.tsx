    ...
    <section className='flexCenter flex-col'>
        <div className=" padding-container max-container w-full pb-24">
            ...
            <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
                ...
                <p className='regular-16 text-gray-30 xl:max-w-[520px]'>Only with the Hilink application you will no longer get lost again, because we already support offline maps when there is no inernet conection in the field. Invite your friends, relatives and friends to have fun in the wilderness through the valley and reach the top of the mountain</p>
            </div>
        </div>
